...
/**
 * Servlet implementation class CargarMovimientos
 */
@WebServlet("/CargarMovimientos")
public class CargarMovimientos extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CargarMovimientos() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			stmt = con.prepareCall("{call stp_pv_tiposMovimiento_New(?)}");
			...
			while(rs.next()){
				...
				dato.setCodigoMovimiento(rs.getInt("Movimiento"));
