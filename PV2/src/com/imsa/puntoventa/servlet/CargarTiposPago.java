...
/**
 * Servlet implementation class CargarTiposPago
 */
@WebServlet("/CargarTiposPago")
public class CargarTiposPago extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CargarTiposPago() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			stmt = con.prepareCall("{call stp_pv_TiposPago_New}");
